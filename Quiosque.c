...
int main()
{
        ...
        //MENU INICIAL, PERGUNTA AO CLIENTE SE ELE QUER LANCHES PRÉ MONTADOS, MONTAR UM LANCHE OU ESCOLHER UMA BEBIDA.
        ...
        //TAMBÉM MOSTRA O ATALHO PARA O MENU DE MONTAGEM DE LANCHES E PARA O MENU DE BEBIDAS
        ...
        case 1:
            ...
            printf("Ingredientes: Pão, uma vina, tomate, milho, cebola, maionese, mostarda , ketchup.\n");
            printf("Preço: R$ 16,00\n");
            ...
            //VARIAVEL QUE RECEBE O PREÇO DO LANCHE, MULTIPLICA A QUANTIDADE DE LANCHES PELO PREÇO UNITARIO E SOMA NO VALOR TOTAL DA COMPRA
            unidade1=16;
            ...
            printf("Você deseja adicionar outro lanche? (1)SIM (2)NÃO\n");
                scanf("%d", &repeat1);
        ...
        case 2:
            ...
            printf("Ingredientes: Pão, duas vinas, tomate, milho, cebola, maionese, mostarda , ketchup.\n");
        ...
        case 3:
            ...
            printf("Ingredientes: Pão, duas vinas, bacon, batata palha, tomate, milho, cebola, farofa, maionese, mostarda, ketchup.\n");
        ...
        case 4:
            ...
            printf("Ingredientes: Pão, duas vinas, calabresa, batata palha, tomate, milho, cebola, farofa, maionese, mostarda, ketchup.\n");
            printf("Preço: R$ 25,00\n");
            printf("Digite a quantidade de lanches:\n");
        ...
        case 5:
            ...
            printf("Ingredientes: Pão, duas vinas, frango, batata palha, tomate, milho, cebola, farofa, maionese, mostarda, ketchup.\n");
            printf("Preço: R$ 25,00\n");
            printf("Digite a quantidade de lanches:\n");
        ...
        case 6:
            ...
            printf("Ingredientes: Pão, duas vinas veganas, batata palha, tomate, milho, farofa, cebola, mostarda, ketchup.\n");
            printf("Preço: R$ 28,00\n");
            printf("Digite a quantidade de lanches:\n");
        ...
        case 7:
            ...
            printf("Ingredientes: Pão, duas vinas, lombinho, batata palha, tomate, milho, cebola, farofa, maionese, mostarda, ketchup.\n");
            printf("Preço: R$ 24,00\n");
            printf("Digite a quantidade de lanches:\n");
        ...
        case 8:
            ...
            printf("Ingredientes: Pão, duas vinas, bacon, calabresa, presunto, batata palha, tomate, milho, cebola, farofa, maionese, mostarda, ketchup.\n");
            printf("Preço: R$ 36,00\n");
            printf("Digite a quantidade de lanches:\n");
        ...
        //CASO O CLIENTE NÃO SELECIONE UMA OPÇÃO VÁLIDA, RECEBE UMA NOTIFICAÇÃO E O PROCESSO SE REPETE.
        default:
        ...
        //REPETE O LOOP ATÉ QUE O CLIENTE DIGITE 2
        }while(repeat1!=2);

        //APÓS FINALIZAR A SELEÇÃO DE LANCHES PRONTOS VAI AUTOMATICAMENTE PARA O MENU DE BEBIDAS
        case 3:
        bebidas1:
            system("cls");

        //LAÇO DE REPETIÇÃO PARA ADICIONAR AS BEBIDAS (DO-WHILE)
        do
        {
        ...
        //PERGUNTA AO CLIENTE O ITEM QUE ELE QUER E ATRIBUI O NUMERO 10 PARA FINALIZAÇÃO DA COMPRA
            printf("Digite o código da bebida para realizar a compra:\n");
        printf("Digite (10) para finalizar a compra!\n");
            ...
            if(escolhabebida==1)
            {
                ...
                printf("Digite quantas unidades você deseja adicionar ao carrinho:\n");
                    scanf("%d", &quantidadebebida1);
                //ESTABELECE O PREÇO DA UNIDADE
                unidade1=4;
                //MULTIPLICA O PREÇO DA UNIDADE PELA QUANTIDADE ESCOLHIDA
                parcial1=unidade1*quantidadebebida1;
                //LIMPA A TELA
                system("cls");
                //CONFIRMA A BEBIDA ESCOLHIDA PARA O CLIENTE
                printf("Você adicionou %d Agua Mineral ao carrinho.\n",quantidadebebida1);
                //SOMA A MULTIPLICAÇÃO AO PREÇO TOTAL DO CARRINHO
                total1+=parcial1;
                //PERGUNTA SE O CLIENTE GOSTARIA DE ADICIONAR OUTRA BEBIDA
                printf("Deseja adicionar outra bebida?\n");
                //ENQUANTO O CLIENTE NÃO DIGITAR O VALOR 10 O LOOP DE REPETIÇÃO CONTINUA FUNCIONANDO
                bebida1=1;
            ...
            if(escolhabebida==2)
            {
                ...
                total1+=parcial1;
                system("cls");
                printf("Você adicionou %d Suco Natural ao carrinho.\n",quantidadebebida2);
                printf("Deseja adicionar outra bebida?\n");
                bebida2=1;
            }
            if(escolhabebida==3)
            {
                ...
                total1+=parcial1;
                system("cls");
                printf("Você adicionou %d Suco Natural na Jarra ao carrinho.\n",quantidadebebida3);
                printf("Deseja adicionar outra bebida?\n");
                bebida3=1;
            }
            if(escolhabebida==4)
            {
                ...
                total1+=parcial1;
                system("cls");
                printf("Você adicionou %d Refrigerante Lata ao carrinho.\n",quantidadebebida4);
                printf("Deseja adicionar outra bebida?\n");
                bebida4=1;
            }
            if(escolhabebida==5)
            {
                ...
                total1+=parcial1;
                system("cls");
                printf("Você adicionou %d Chá Matte ao carrinho.\n",quantidadebebida5);
                printf("Deseja adicionar outra bebida?\n");
                bebida5=1;
            }
            if(escolhabebida==6)
            {
                ...
                total1+=parcial1;
                system("cls");
                printf("Você adicionou %d Suco Del Valle ao carrinho.\n",quantidadebebida6);
                printf("Deseja adicionar outra bebida?\n");
                bebida6=1;
            }
            if(escolhabebida==7)
            {
                ...
                total1+=parcial1;
                system("cls");
                printf("Você adicionou %d Refrigerante 600ML ao carrinho.\n",quantidadebebida7);
                printf("Deseja adicionar outra bebida?\n");
                bebida7=1;
            }
            if(escolhabebida==8)
            {
                ...
                total1+=parcial1;
                system("cls");
                printf("Você adicionou %d Refrigerante 1L ao carrinho.\n",quantidadebebida8);
                printf("Deseja adicionar outra bebida?\n");
                bebida8=1;
            }
            if(escolhabebida==9)
            {
                ...
                total1+=parcial1;
                system("cls");
                printf("Você adicionou %d Refrigerante 2L ao carrinho.\n",quantidadebebida9);
                printf("Deseja adicionar outra bebida?\n");
                bebida9=1;
            }
            //SE O CLIENTE NÃO ESCOLHER UMA OPÇÃO VÁLIDA, EMITE UM AVISO E REPETE A OPERAÇÃO
if(escolhabebida!=1 && escolhabebida!=2 && escolhabebida!=3 && escolhabebida!=4 && escolhabebida!=5 && escolhabebida!=6 && escolhabebida!=7 && escolhabebida!=8 && escolhabebida!=9 && escolhabebida!=10)
        ...
        //PARA O LAÇO DE REPETIÇÃO QUANDO O CLIENTE DIGITA 10
        ...
        //CASE PARA A MONTAGEM DE LANCHES PRÓPRIOS
        case 2:
        montagem1:
            system("cls");
            ...
            //LAÇO DE REPETIÇÃO PARA A MONTAGEM DE LANCHES
            do
            {

            //ATRIBUI VALORES AOS TAMANHOS DE PÃES E SEUS RESPECTIVOS PREÇOS
            printf("Selecione o tamanho do pão:\n");
            ...
            printf("Digite 6 para finalizar a compra.\n");
                ...
                switch (tamanho1)
                {
                    //PRIMEIRO CASE (PÃO GRANDE)
                    case 1:

                        //LIMPA A TELA APÓS A SELEÇÃO DO TAMANHO DO PÃO
                        system("cls");
                        //CONFIRMA A SELEÇÃO DO CLIENTE
                        printf("Você selecionou o pão grande.\n");
                        //ADICIONA O PREÇO DO PÃO AO VALOR TOTAL DA COMPRA
                        total1+=12;
                        parcialmontado1+=12;
                        //ATRIBUI VALOR A VARIAVEL MONTADO1 PARA A NOTA FISCAL
                        montado1=1;
                        //APRESENTA PARA O CLIENTE O LIMITE DE INGREDIENTES PARA O TAMANHO DO PÃO
                        printf("Você pode adicionar até 8 ingredientes para o seu lanche!\n");

                        //LAÇO DE REPETIÇÃO PARA O CLIENTE SELECIONAR ATÉ 8 INGREDIENTS
                        for(contador1=0; contador1<8; contador1++)
                        {


                            //MENU DE INGREDIENTES DISPONIVEIS PARA A MONTAGEM DO LANCHE
                            //ATRIBUI UM NUMERO A CADA INGREDIENTE E SEU RESPECTIVO PREÇO
                            ...
                            printf("Digite o código do ingrediente para adiciona-lo ao lanche:\n");

                                //APRESENTA A OPÇÃO DE FINALIZAR A MONTAGEM ANTES DE ATINGIR O LIMITE DE INGREDIENTES
...
if(escolhaingrediente!=0 || escolhaingrediente!=1 || escolhaingrediente!=2 || escolhaingrediente!=3 || escolhaingrediente!=4 || escolhaingrediente!=5 || escolhaingrediente!=6 || escolhaingrediente!=7 || escolhaingrediente!=8 || escolhaingrediente!=9 || escolhaingrediente!=10 || escolhaingrediente!=11 || escolhaingrediente!=12)
                                ...
                                //CASO O CLIENTE ESCOLHA UM VALOR VÁLIDO
                ...
                break;
                    ...
                    case 2:
                        ...
                        system("cls");
                        printf("Você selecionou o pão médio.\n");
                        total1+=8;
                        parcialmontado2+=8;
                        montado2=1;
                        printf("Você pode adicionar até 6 ingredientes para o seu lanche!\n");
...
if(escolhaingrediente!=0 || escolhaingrediente!=1 || escolhaingrediente!=2 || escolhaingrediente!=3 || escolhaingrediente!=4 || escolhaingrediente!=5 || escolhaingrediente!=6 || escolhaingrediente!=7 || escolhaingrediente!=8 || escolhaingrediente!=9 || escolhaingrediente!=10 || escolhaingrediente!=11 || escolhaingrediente!=12)
                ...
                break;
                    ...
                    case 3:
                        ...
                        system("cls");
                        printf("Você selecionou o pão pequeno.\n");
                        total1+=5;
                        parcialmontado3+=5;
                        montado3=1;
                        printf("Você pode adicionar até 4 ingredientes para o seu lanche!\n");
...
if(escolhaingrediente!=0 || escolhaingrediente!=1 || escolhaingrediente!=2 || escolhaingrediente!=3 || escolhaingrediente!=4 || escolhaingrediente!=5 || escolhaingrediente!=6 || escolhaingrediente!=7 || escolhaingrediente!=8 || escolhaingrediente!=9 || escolhaingrediente!=10 || escolhaingrediente!=11 || escolhaingrediente!=12)
                ...
                //LAÇO DE REPETIÇÃO ACONTECE ATÉ QUE O CLIENTE DECIDA IR ATÉ OUTRO MENU
                while(tamanho1!=4 || tamanho1!=5);
                //SE O CLIENTE DIGITAR 4 ELE É DIRECIONADO ATÉ O MENU DE LANCHES PRONTOS
                if(tamanho1=4)
                {
                    goto prontos1;
                }
                //SE O CLIENTE DIGITAR 5 ELE É DIRECIONADO ATÉ O MENU DE BEBIDAS
                else if(tamanho1=5)
                {
                    goto bebidas1;
                }
            ...
            cupomfiscal:
                ...
                printf("(5) Vale Refeição\n");
                printf("(6) Vale Alimentação\n");
                ...
                case 4:
                    ...
                    break;
                case 5:
                    printf("Forma de pagamento: Vale refeição\n");
                    break;
                case 6:
                    printf("Forma de pagamento: Vale alimentação\n");
                    break;
                //CASO NÃO SEJA ESCOLHIDO UMA FORMA DE PAGAMENTO VÁLIDA, NOTIFICA O USUÁRIO E DIRECIONA ELE PARA A ESCOLHA DE FORMA DE PAGAMENTO DE NOVO
                default:
